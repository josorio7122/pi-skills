...
```bash
gh config set editor vim            # Default editor
gh config set git_protocol ssh      # Git protocol
gh config set browser "firefox"     # Default browser
gh config set prompt disabled       # Disable prompts
gh config list                      # View current config
